...
```json
{
  "waves": [
    ...
    { "wave": 6, "tasks": [12], "description": "Init function wiring and storage error handling" },
    { "wave": 7, "tasks": [13], "description": "Final integration review and verification" }
  ]
}
```
